...
export default function Departments({ departments, total }: Props) {
  return (
    <>
      <Head>
        <title>Ministries — Egypt Open Data Portal</title>
      </Head>
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-8">
          <nav className="mb-3 text-sm text-gray-500">
            ...
            <span className="text-gray-700">Ministries</span>
          </nav>
          <h1 className="text-3xl font-bold text-gray-900">Ministries</h1>
          <p className="mt-1 max-w-2xl text-base text-gray-500 sm:text-sm">
            Open data published across Egyptian government ministries —
            {' '}{total} datasets from {departments.length} ministries.
          </p>
