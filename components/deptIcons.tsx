...
const ICONS: Record<string, Icon> = {
  // Egypt ODP ministry sub-organisations
  'ministry-of-finance': BanknotesIcon,
  'ministry-of-health': HeartIcon,
  'ministry-of-environment': GlobeAltIcon,
  // Egypt ODP themes (CKAN groups)
  'economy-and-finance': BanknotesIcon,
  energy: BoltIcon,
  'environment-and-climate': GlobeAltIcon,
  'population-and-demographics': UsersIcon,
  'public-health': HeartIcon,
